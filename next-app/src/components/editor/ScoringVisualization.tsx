...
// V4 フラグ定義 (日本語ラベル用)
const V4_FLAG_DEFINITIONS: Record<string, string> = {
    // 雰囲気
    "casual_moment": "ふとした瞬間",
    "nostalgic": "思い出・フィルム感",
    "crowd_venue": "イベント会場・人混み",
    "group_feeling": "仲間・複数人",
    // 表情・ポーズ
    "talk_to": "話しかけ・コミニュケーション",
    "close_dist": "近距離",
    "costume_strong": "衣装・役作り強",
    "act_point_or_salute": "アクション・指差し",
    "prop_strong": "小道具・物持ち",
    // 向き
    "pose_safe_theory": "無難・セオリー",
    "pose_front_true": "真正面",
    "pose_side_cool": "斜め・クール",
    "pose_front_body_face_angled": "体正面・顔斜め",
};

// カテゴリ別の色定義（V3.0の名残だが、A-Eスコア表示で再利用）
const SCORE_COLORS = {
    A: "bg-blue-500",
    B: "bg-cyan-500",
    C: "bg-pink-500",
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            {[
                                ...
                                const colorClass = SCORE_COLORS[key as keyof typeof SCORE_COLORS] || "bg-gray-500";
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-1">
                                {detectedCriteria.map(flag => (
                                    <span key={flag} className="px-2 py-1 rounded-sm bg-white/5 border border-white/10 text-[10px] text-white" title={flag}>
                                        {V4_FLAG_DEFINITIONS[flag] || flag}
                                    </span>
                                ))}
                            </div>
                        </div>
